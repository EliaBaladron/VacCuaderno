 ...
 */
public class Activity_Crotal_Pedidos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crotal_pedidos);
    ...
    void iniciarComponentes(){
        ...
        fab_editar = findViewById(R.id.crotal_p_editar);
        fab_eliminar = findViewById(R.id.crotal_p_eliminar);
        fab_volver = findViewById(R.id.crotal_p_volver);
        fab_aceptar = findViewById(R.id.crotal_p_aceptar);
        fab_cancelar = findViewById(R.id.crotal_p_cancelar);
    }
