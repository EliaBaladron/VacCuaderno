 ...
 */
public class GridAdapter_Controles extends BaseAdapter {
    private final Context context;
    private final ArrayList<Controles> arrayList;
     ...
     */
    public GridAdapter_Controles(Context cont, ArrayList<Controles> al){
        this.context = cont;
        this.arrayList = al;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        textViewOtro.setText(arrayList.get(position).getNumRegistro());
