...
public class Activity_Crotal_Faltan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crotal_faltan);
    ...
    void iniciarComponentes(){
        ...
        fab_editar = findViewById(R.id.crotal_f_editar);
        fab_eliminar = findViewById(R.id.crotal_f_eliminar);
        fab_volver = findViewById(R.id.crotal_f_volver);
        fab_aceptar = findViewById(R.id.crotal_f_aceptar);
        fab_cancelar = findViewById(R.id.crotal_f_cancelar);
    }
