...
public class Activity_Crotal_SinPoner extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crotal_sinponer);
    ...
    void iniciarComponentes(){
        ...
        fab_editar = findViewById(R.id.crotal_sp_editar);
        fab_eliminar = findViewById(R.id.crotal_sp_eliminar);
        fab_volver = findViewById(R.id.crotal_sp_volver);
        fab_aceptar = findViewById(R.id.crotal_sp_aceptar);
        fab_cancelar = findViewById(R.id.crotal_sp_cancelar);
    }
    void iniciarListenerBotones(){
        fab_editar.setOnClickListener(view -> {
            Snackbar.make(view, "Editar "+crotal.getCrotal(), Snackbar.LENGTH_LONG)
        ...
        fab_eliminar.setOnClickListener(view -> {
            Snackbar.make(view, "Eliminar "+crotal.getCrotal(), Snackbar.LENGTH_LONG)
                    .setAction("Action", null).show();
        ...
        fab_volver.setOnClickListener(view -> {
            Snackbar.make(view, "Volver "+crotal.getCrotal(), Snackbar.LENGTH_LONG)
                    .setAction("Action", null).show();
        ...
        fab_aceptar.setOnClickListener(view -> {
            Snackbar.make(view, "Aceptar "+crotal.getCrotal(), Snackbar.LENGTH_LONG)
                    .setAction("Action", null).show();
        ...
        fab_cancelar.setOnClickListener(view -> {
            Snackbar.make(view, "Cancelar "+crotal.getCrotal(), Snackbar.LENGTH_LONG)
                    .setAction("Action", null).show();
