...
public class BD_Crotales_Recibidos extends AppCompatActivity {
    ...
    public ArrayList<Crotal> getDatosObjetos(){
        ...
        Cursor cursor = db.query(
                FeedReaderContract_Crotales_Recibidos.FeedEntry.TABLE_NAME,   // The table to query
    ...
    /*ArrayList<Long> obtenerIDs(Cursor cursor){
        ...
        while(cursor.moveToNext()) {
            long itemId = cursor.getLong(
                    cursor.getColumnIndexOrThrow(FeedReaderContract_Crotales_Recibidos.FeedEntry._ID));
            items.add(itemId);
        }
        return items;
    }*/
    /*ArrayList<String> obtenerTitulos(Cursor cursor){
        ...
        while(cursor.moveToNext()) {
            String item = cursor.getString(cursor.getColumnIndex(FeedReaderContract_Crotales_Recibidos.FeedEntry.CROTAL));
            items.add(item);
        }
        return items;
    }*/
