 ...
 */
public class GridAdapter_Animal extends BaseAdapter {
    private final Context context;
    private final ArrayList<Animal> arrayList;
     ...
     */
    public GridAdapter_Animal(Context cont, ArrayList<Animal> al){
        this.context = cont;
        this.arrayList = al;
    }
